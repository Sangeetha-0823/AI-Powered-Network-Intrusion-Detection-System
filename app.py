...
st.markdown("""
This system uses *Random Forest Machine Learning* to detect malicious
network traffic.
...
if st.button("Analyze Packet"):
    if "model" in st.session_state:
        ...
        if prediction[0] == 1:
            ...
            st.write("Reason: High packet count with abnormal duration.")
        else:
